...
//	var sprite *graphic.CharacterSprite
//	//if sprite, err = graphic.LoadCharacterSprite(grfFile, character.Male, jid); err != nil {
//	//	log.Fatal(err)
//	//}
//	if sprite, err = graphic.LoadCharacterSprite(grfFile, character.Female, jid); err != nil {
//		log.Fatal(err)
//	}
//
